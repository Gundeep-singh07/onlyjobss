    ...
    projects: [
      {
        ...
        image:
          "https://cdn.shopify.com/s/files/1/0070/7032/files/best-web-design-3.png?v=1691010811",
      },
      {
        id: 2,
      ...
      },
      {
        ...
        image:
          "https://images.ctfassets.net/ukazlt65o6hl/gvI3xgLy4EVayvpZ60HSl/793e5c2763c324d5851535ef7c04575a/Hootsuite_social_analytics_dashboard.png",
      },
    ],
    education: [
      {
            ...
            <div className="profile-info-container">
              ...
              <div className="profile-details">
                ...
                <div className="profile-actions">
                  ...
                  <button className="secondary-btn">Share Profile</button>
                </div>
              </div>
            </div>
          </section>
          ...
          {activeTab === "about" && (
            <div className="profile-content">
              ...
              <section className="profile-section">
                ...
                {!showAllProjects && userProfile.projects.length > 2 && (
                  <button
